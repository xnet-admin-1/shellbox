package com.shellbox.terminal.view;
...
import com.shellbox.R;
import com.shellbox.terminal.component.completion.OnAutoCompleteListener;
import com.shellbox.terminal.backend.*;
import com.shellbox.terminal.view.gesture.GestureAndScaleRecognizer;
...
public final class TerminalView extends View {
  ...
  private void commonInit(Context context) {
    mTextSize = (int) (18 * context.getResources().getDisplayMetrics().scaledDensity);
    Typeface jbMono = null;
    try {
      android.content.res.AssetManager assets = context.getApplicationContext().getAssets();
      jbMono = Typeface.createFromAsset(assets, "fonts/JetBrainsMono-Regular.ttf");
    } catch (Exception ignored) {}
    mRenderer = new TerminalRenderer(mTextSize, jbMono != null ? jbMono : Typeface.MONOSPACE);
    ...
    // Required for keyboard input and IME to attach
    setFocusable(true);
    setFocusableInTouchMode(true);
    // Required for context menu (long-press copy/paste)
  ...
  public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
    ...
    // Required on Android 11+ to avoid commitText mSessionId mismatch
   ...
   */
  public float getFontWidth() { return mRenderer == null ? 8f : mRenderer.mFontWidth; }
  public int getFontLineSpacingAndAscent() { return mRenderer == null ? 16 : mRenderer.mFontLineSpacingAndAscent; }
